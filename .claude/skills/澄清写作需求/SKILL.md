...
### 2. 确认核心六要素 (6 Essential Elements)
只在未明确时有针对性地追问：
...
- **反AI格式要求（重要！）：** 
    - 询问用户："您希望文章使用小标题吗？还是一气呵成的段落流？"
    - 告知用户：默认情况下，我会避免使用"首先/其次/最后"等AI常用词，避免整齐划一的段落长度，避免过多加粗。如有特殊需求请说明。
...
## 最佳实践 (Best Practices)
- **反AI格式必须确认：** 在开始写作前，必须明确用户对小标题、段落结构、过渡词的偏好。这决定了文章能否通过读者的"AI检测直觉"。
